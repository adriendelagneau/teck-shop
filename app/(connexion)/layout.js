...
export default function RootLayout({ children }) {
  return (
<>
        <header className={`w-full bg-light-secondary dark:bg-dark-primary text-light-primary dark:text-dark-primary transform transition-transform fixed top-0 h-16 z-50  left-[50%] translate-x-[-50%] max-w-screen-2xl`}>
        <nav className='flex items-center justify-between w-full h-full py-2 pl-4'>
