...
const Header = () => {
    ...
    return (
        <header className={`w-full bg-skin-inverted  dark:bg-skin-fill text-skin-base dark:text-skin-inverted transform transition-transform fixed top-0 h-16 z-50 ${!visible && 'translate-y-[-64px]'} left-[50%] translate-x-[-50%] max-w-screen-2xl`}>
