...
const Footer = () => {
  return (
    <footer className="relative pt-8 pb-6 dark:text-skin-inverted">
          ...
          <div className="w-full px-4 lg:w-6/12">
            ...
            <div className="mt-6 mb-6 lg:mb-0">
              ...
              <div className='flex gap-6 '>
                ...
                <Link href={"/#"} className='w-8 h-8 transition-all cursor-pointer text-skin-base dark:text-skin-inverted'>
