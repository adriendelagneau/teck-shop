  ...
  return (
    <footer className="relative pt-8 pb-6 ">
      <div className="container px-4 mx-auto">
          ...
          <div className="w-full px-4 lg:w-6/12">
            ...
            <div className="mt-6 mb-6 lg:mb-0">
              ...
              <div className='flex gap-6 '>
                ...
                <Link href={"/#"} className='w-8 h-8 transition-all cursor-pointer '>
          ...
          <div className="w-full px-4 lg:w-6/12">
            <div className="flex flex-wrap mb-6 items-top">
              <div className="w-full px-4 ml-auto lg:w-4/12">
                <span className="block mb-2 text-xl font-semibold uppercase text-blueGray-500">Useful Links</span>
              ...
              <div className="w-full px-4 lg:w-4/12">
                <span className="block mb-2 text-xl font-semibold uppercase text-blueGray-500">Other Resources</span>
                <ul className="list-unstyled">
                  <li>
        ...
        <hr className="my-6 border-light_primary dark:border-dark_primary" />
