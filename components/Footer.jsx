          ...
          <div className="w-full px-4 lg:w-6/12">
            ...
            <div className="mt-6 mb-6 lg:mb-0">
              <div className="flex gap-6 ">
                <Link
                  href={"/#"}
                  className="w-8 h-8 transition-all cursor-pointer hover:text-almond_green"
                >
                  <svg
                    role="img"
                    viewBox="0 0 24 24"
          ...
          <div className="w-full px-4 lg:w-6/12">
            <div className="flex flex-wrap mb-6 items-top">
              <div className="w-full px-4 ml-auto lg:w-4/12">
                <span className="block mb-2 text-xl font-semibold uppercase text-blueGray-500">
                  Useful Links
                </span>
        ...
        <div className="flex flex-wrap items-center justify-center md:justify-between">
          <div className="w-full px-4 mx-auto text-center md:w-4/12">
            <div className="py-1 text-sm font-semibold text-blueGray-500">
              ...
              <Link
                href="https://webagence.vercel.app/"
